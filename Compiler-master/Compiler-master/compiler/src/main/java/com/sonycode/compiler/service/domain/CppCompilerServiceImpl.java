...
public class CppCompilerServiceImpl implements CppCompilerService {
    ...
    Logger logger = LoggerFactory.getLogger(CppCompilerService.class);
	...
	public String compileCode(CodeDTO codeDTO) 
	{
		...
		try {
			   ...
			   filePath = applicationPath + "/src/main/resources/CodeFiles/CppFile/"+ randomFolderName + "/";	   
			   commonService.createFolder(filePath);
			   logger.info("FilePath : {}",filePath);
			   String fileName = "main";
			   FileWriter fWriter = new FileWriter(filePath + fileName + ".cpp");
	...
	private void compileCode(String filePath,String fileName,OutputDTO outPutDTO) throws Exception
	  {
		...
		CommandLineExecutor commandLineExecutor = new CommandLineExecutor(filePath,"g++ "+fileName+ ".cpp");
		commandLineExecutor.run();
		StdOutErrorDTO stdOutErrorDTO = commandLineExecutor.getStdOutErrorDTO();
