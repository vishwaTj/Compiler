...
public class PythonCompilerServiceImpl  implements PythonCompilerService{
    ...
    Logger logger = LoggerFactory.getLogger(PythonCompilerService.class);
	...
	public String compileCode(CodeDTO codeDTO) 
	{
		...
		try {
			   ...
			   filePath = applicationPath + "/src/main/resources/CodeFiles/PythonFile/"+ randomFolderName + "/";	   
			   commonService.createFolder(filePath);
			   logger.info("FilePath : {}",filePath);
			   String fileName = "Main";
			   FileWriter fWriter = new FileWriter(filePath + fileName + ".py");
	...
	private void runCode(OutputDTO outPutDTO, String filePath, String fileName) throws Exception {
		...
		CommandLineExecutor commandLineExecutor  = new CommandLineExecutor(filePath,"python3 "+fileName+".py");
